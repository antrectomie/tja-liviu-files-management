...
public interface TransactionFileReaderFactory {
    ...
    public static TransactionFileReader createTransactionFileReader(String fileName) {
        ...
        switch (fileType) {
            ...
            default:
                throw new IllegalArgumentException("Unknown file type, we don't have a reader for this");
        }
    }
